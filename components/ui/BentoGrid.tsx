...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('oybektoshmatov95@gmail.com');
        setCopied(true);
    };
    return (
        <div
                    ...
                    {id === 3 && (
                        <div className='flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2'>
                            <div className='flex flex-col gap-3 lg:gap-8'>
                                {['React.js', 'Next.js', 'JavaScript', 'TypeScript', 'Redux'].map((item) => (
                                    <span
                                        key={item}
                                        className='py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg=[#10132E] text-white-200'
                                    >
                                        {item}
                                    </span>
                                ))}
